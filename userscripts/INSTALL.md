...
> - **XP Watch 0.10.0** — local file differs from `origin/main`; the raw link serves the older version.
...
**Message 1 of 2** — 1574 characters
...
| 2 | `XP` | XP Watch | 0.10.0 | ledger of your own stat and skill changes, action by action | [`xp-watch.user.js`](https://raw.githubusercontent.com/dataterminals/politiko-research/main/userscripts/xp-watch.user.js) |
...
| 13 | `POLL` | Poll Watch | 0.9.0 | files every opinion-poll memo, bucket-by-bucket delta against your last one | [`poll-watch.user.js`](https://raw.githubusercontent.com/dataterminals/politiko-research/main/userscripts/poll-watch.user.js) |
