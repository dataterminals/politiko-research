...
docs/     numbered findings + plan; 00 recon, 01 rules, 02 plan, 03 ideas,
          ...
          10 xp, 11 faction raids, 12 navigation
...
userscripts/  _template.user.js — passive-tap skeleton + WS TAP + PANEL KIT;
              ...
              quick-jump; README.md documents them; tools/ holds their tests, and
              tools/harness/ is a browser bench that renders a panel against canned
              payloads with fetch/WebSocket/XHR stubbed out, so no panel work needs
              the live game. Every userscript ships from here — no separate repos
